function fit_out = fit_model_to_melatonin_wrapper(data_points, stats, error_for_fit, ...
    ...
    [spec, points, stats_out, actSpectra, final_x, fval, output_struct, statParam, x0_names] = ...
        fit_QuickPooling_simple_v2018(stats.x, stats.y, error_for_fit, group, model_name);
